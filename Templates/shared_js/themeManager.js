...
var themeManager = (function () {
    ...
    function updateThemeWithAppSkinInfo(appSkinInfo) {
        ...
        if (isLight) {
            $("#theme").attr("href", $$SHORTCODE$$.C.CSS_ROOT + "/topcoat-desktop-light.css");
        } else {
            $("#theme").attr("href", $$SHORTCODE$$.C.CSS_ROOT + "/topcoat-desktop-dark.css");
        }
    }
 
    $$SHORTCODE$$.requestThemeInfo = function requestThemeInfo() {
        var skinInfo = JSON.parse(window.__adobe_cep__.getHostEnvironment()).appSkinInfo;
        $$SHORTCODE$$.sendThemeChangeEventFromCEPToIFrame(skinInfo);
    }
    ...
    function init() {
        if ($$SHORTCODE$$.C.PLATFORM == $$SHORTCODE$$.C.BROWSER_JAVASCRIPT) {
            ...
            $$SHORTCODE$$.updateThemeWithAppSkinInfo = updateThemeWithAppSkinInfo;
        }
        else {
