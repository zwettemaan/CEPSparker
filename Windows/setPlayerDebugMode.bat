...
REG add HKEY_CURRENT_USER\Software\Adobe\CSXS.11 /v LogLevel /t REG_SZ /d 5 /f > NUL
REG add HKEY_CURRENT_USER\Software\Adobe\CSXS.12 /v PlayerDebugMode /t REG_SZ /d 1 /f > NUL
REG add HKEY_CURRENT_USER\Software\Adobe\CSXS.12 /v LogLevel /t REG_SZ /d 5 /f > NUL
