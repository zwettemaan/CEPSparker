...
XCOPY "%projectHomeDir%css" "%EXTENSION_HOMEDIR%css\" /y /s /e
XCOPY "%projectHomeDir%CSXS" "%EXTENSION_HOMEDIR%CSXS\" /y /s /e
XCOPY "%projectHomeDir%html" "%EXTENSION_HOMEDIR%html\" /y /s /e
XCOPY "%projectHomeDir%js" "%EXTENSION_HOMEDIR%js\" /y /s /e
XCOPY "%projectHomeDir%jsx" "%EXTENSION_HOMEDIR%jsx\" /y /s /e
XCOPY "%projectHomeDir%shared_js_jsx" "%EXTENSION_HOMEDIR%shared_js_jsx\" /y /s /e
